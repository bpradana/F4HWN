...
enum { VFO_CONFIGURE_NONE = 0, VFO_CONFIGURE, VFO_CONFIGURE_RELOAD };
...
typedef union {
    struct {
        uint8_t band : 3, compander : 2, scanlist1 : 1, scanlist2 : 1, scanlist3 : 1;
    };
    uint8_t __val;
} ChannelAttributes_t;
...
enum { SCAN_REV = -1, SCAN_OFF = 0, SCAN_FWD = +1 };

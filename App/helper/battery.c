...
typedef enum { BATTERY_LOW_INACTIVE, BATTERY_LOW_ACTIVE, BATTERY_LOW_CONFIRMED } BatteryLow_t;
...
void BATTERY_GetReadings(const bool bDisplayBatteryLevel) {
    ...
    if (gBatteryVoltageAverage > 890)
    ...
    else if (gBatteryVoltageAverage < 630 && (gEeprom.BATTERY_TYPE == BATTERY_TYPE_1600_MAH ||
        ...
        // gBatteryVoltages[2], gBatteryVoltages[3], Voltage, gBatteryVoltageAverage, perc);
        // LogUart(str);

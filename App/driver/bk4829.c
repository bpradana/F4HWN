...
void BK4819_Init(void) {
    ...
    // BK4819_WriteRegister(BK4819_REG_19, 0b0001000001000001);   // <15> MIC AGC  1 = disable  0 =
    // enable
    ...
    BK4819_WriteRegister(
        BK4819_REG_48, //  0xB3A8);     // 1011 00 111010 1000
                       // (11u << 12) |     // ??? 0..15
                       // ( 0u << 10) |     // AF Rx Gain-1
                       // (58u <<  4) |     // AF Rx Gain-2
...
void BK4819_InitAGC(bool amModulation) {
    ...
    if (amModulation) {
        ...
        BK4819_WriteRegister(BK4819_REG_49, (0 << 14) | (84 << 7) |
...
int8_t BK4819_GetRxGain_dB(void) {
    ...
    return lnaShortTab[agcGainReg.lnaS] + lnaTab[agcGainReg.lna] + mixerTab[agcGainReg.mixer] +
...
void BK4819_SetCTCSSFrequency(uint32_t FreqControlWord) {
    ...
    // REG_51 <14>  0                                 1 = GPIO0Input for CDCSS           0 = Normal
    // Mode.(for BK4819v3) REG_51 <13>  0                                 1 = Transmit negative
    // CDCSS code   0 = Transmit positive CDCSScode REG_51 <12>  0 CTCSS/CDCSS mode selection      1
    // = CTCSS                          0 = CDCSS REG_51 <11>  0 CDCSS 24/23bit selection        1 =
    // 24bit                          0 = 23bit REG_51 <10>  0 1050HzDetectionMode             1 =
    // 1050/4 Detect Enable, CTC1 should be set to 1050/4 Hz REG_51 <9>   0 Auto CDCSS Bw Mode 1 =
    // Disable                        0 = Enable. REG_51 <8>   0 Auto CTCSS Bw Mode              0 =
    // Enable                         1 = Disable REG_51 <6:0> 0 CTCSS/CDCSS Tx Gain1 Tuning     0 =
    // min                            127 = max
...
void BK4819_SetTailDetection(const uint32_t freq_10Hz) {
    ...
    //                          freq(Hz) * 20.97152 for XTAL 12.8M/19.2M/25.6M/38.4M
    //
    BK4819_WriteRegister(BK4819_REG_07, BK4819_REG_07_MODE_CTC2 | ((253910 + (freq_10Hz / 2)) /
...
void BK4819_SetupSquelch(uint8_t SquelchOpenRSSIThresh, uint8_t SquelchCloseRSSIThresh,
    ...
    BK4819_WriteRegister(BK4819_REG_4F,
                         ((uint16_t)SquelchCloseNoiseThresh << 8) | SquelchOpenNoiseThresh);
    ...
    BK4819_WriteRegister(BK4819_REG_78,
                         ((uint16_t)SquelchOpenRSSIThresh << 8) | SquelchCloseRSSIThresh);
...
void BK4819_SetCompander(const unsigned int mode) {
    ...
    BK4819_WriteRegister(BK4819_REG_29, // (BK4819_ReadRegister(BK4819_REG_29) & ~(3u << 14)) |
                                        // (compress_ratio << 14));
    ...
    BK4819_WriteRegister(BK4819_REG_28, // (BK4819_ReadRegister(BK4819_REG_28) & ~(3u << 14)) |
                                        // (expand_ratio << 14));
...
void BK4819_SetupAircopy(void) {
    ...
    BK4819_WriteRegister(
        BK4819_REG_58,
        0x00C1); // FSK Enable, FSK 1.2K RX Bandwidth, Preamble 0xAA or 0x55, RX Gain 0, RX Mode
    ...
    BK4819_WriteRegister(BK4819_REG_5D, 0x4700); // FSK Data Length 72 Bytes (0xabcd + 2 byte length
                                                 // + 64 byte payload + 2 byte CRC + 0xdcba)
...
void BK4819_PlayDTMF(char Code) {
    ...
    const struct DTMF_TonePair tones[] = {
        ...
        {770, 1477}, {852, 1209}, {852, 1336}, {852, 1477}, {697, 1633}, {770, 1633},
    ...
    if (pSelectedTone) {
        BK4819_WriteRegister(BK4819_REG_71, (((uint32_t)pSelectedTone->tone1 * 103244) + 5000) /
                                                10000); // with rounding
        BK4819_WriteRegister(BK4819_REG_72, (((uint32_t)pSelectedTone->tone2 * 103244) + 5000) /
                                                10000); // with rounding
    }
}
...
void BK4819_TransmitTone(bool bLocalLoopback, uint32_t Frequency) {
    ...
    //
    BK4819_WriteRegister(BK4819_REG_70, BK4819_REG_70_MASK_ENABLE_TONE1 |
...
void BK4819_PrepareFSKReceive(void) {
    ...
    BK4819_WriteRegister(BK4819_REG_3F,
                         0 | BK4819_REG_3F_FSK_RX_FINISHED | BK4819_REG_3F_FSK_FIFO_ALMOST_FULL);
...
static void BK4819_PlayRogerNormal(void) {
    ...
    BK4819_WriteRegister(BK4819_REG_70, // BK4819_REG_70_ENABLE_TONE1 | (66u <<
